...
template <> struct is_proto_enum< ::NFMsg::ESynMsgID> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::NFMsg::EPropertyType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::NFMsg::EPropertyType>() {
  return ::NFMsg::EPropertyType_descriptor();
}
template <> struct is_proto_enum< ::NFMsg::EGameElementType> : ::google::protobuf::internal::true_type {};
template <>
