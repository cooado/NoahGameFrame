...
#ifndef PROTOBUF_INCLUDED_NFMsgURl_2eproto
#define PROTOBUF_INCLUDED_NFMsgURl_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_NFMsgURl_2eproto 
...
namespace google {
namespace protobuf {
template<> ::NFMsg::PackSURLParam* Arena::CreateMaybeMessage<::NFMsg::PackSURLParam>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace NFMsg {
...
class PackSURLParam : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:NFMsg.PackSURLParam) */ {
 public:
  ...
  inline PackSURLParam* New() const final {
    return CreateMaybeMessage<PackSURLParam>(NULL);
  }

  PackSURLParam* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<PackSURLParam>(arena);
  }
...
inline ::std::string* PackSURLParam::release_strurl() {
  ...
  clear_has_strurl();
  return strurl_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackSURLParam::release_strgetparams() {
  ...
  clear_has_strgetparams();
  return strgetparams_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackSURLParam::release_strbodydata() {
  ...
  clear_has_strbodydata();
  return strbodydata_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackSURLParam::release_strcookies() {
  ...
  clear_has_strcookies();
  return strcookies_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackSURLParam::release_strrsp() {
  ...
  clear_has_strrsp();
  return strrsp_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#endif  // PROTOBUF_INCLUDED_NFMsgURl_2eproto
