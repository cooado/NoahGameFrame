...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_NFMsgMysql_2eproto 
...
namespace google {
namespace protobuf {
template<> ::NFMsg::PackMysqlParam* Arena::CreateMaybeMessage<::NFMsg::PackMysqlParam>(Arena*);
template<> ::NFMsg::PackMysqlServerInfo* Arena::CreateMaybeMessage<::NFMsg::PackMysqlServerInfo>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace NFMsg {
...
inline ::std::string* PackMysqlParam::release_strrecordname() {
  ...
  clear_has_strrecordname();
  return strrecordname_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackMysqlParam::release_strkey() {
  ...
  clear_has_strkey();
  return strkey_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackMysqlServerInfo::release_strdbname() {
  ...
  clear_has_strdbname();
  return strdbname_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackMysqlServerInfo::release_strdnsip() {
  ...
  clear_has_strdnsip();
  return strdnsip_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackMysqlServerInfo::release_strdbuser() {
  ...
  clear_has_strdbuser();
  return strdbuser_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* PackMysqlServerInfo::release_strdbpwd() {
  ...
  clear_has_strdbpwd();
  return strdbpwd_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
