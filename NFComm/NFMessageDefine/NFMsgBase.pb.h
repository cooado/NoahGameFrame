...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_NFMsgBase_2eproto 
...
inline ::std::string* ObjectRecordSwap::release_origin_record_name() {
  ...
  clear_has_origin_record_name();
  return origin_record_name_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* ObjectRecordSwap::release_target_record_name() {
  ...
  clear_has_target_record_name();
  return target_record_name_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline void MsgBase::clear_hash_ident() {
  if (hash_ident_ != NULL) hash_ident_->Clear();
...
inline void ReqCommand::clear_control_id() {
  if (control_id_ != NULL) control_id_->Clear();
...
inline ::std::string* ReqCommand::release_command_str_value() {
  ...
  clear_has_command_str_value();
  return command_str_value_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* ReqCommand::release_command_value_str() {
  ...
  clear_has_command_value_str();
  return command_value_str_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline void ReqCommand::clear_command_value_object() {
  if (command_value_object_ != NULL) command_value_object_->Clear();
