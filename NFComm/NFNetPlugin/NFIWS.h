...
struct NF_WS_CONFIG_NO_TLS : public websocketpp::config::asio {
	// pull default settings from our core config
...
typedef websocketpp::server<NF_WS_CONFIG_NO_TLS> NFWebSockConfNoTLS;
...
typedef std::function<websocketpp::http::status_code::value(const string&, const string&, string&)> NF_WS_HTTP_CALL_BACK;
